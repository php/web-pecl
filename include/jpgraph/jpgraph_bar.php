...
// PUBLIC METHODS	
    ...
    // DEPRECATED JUST KEEP THIS AS WARNING FOR NOW
    function ShowValue($f=true) {
	JpGraphError::Raise("BarPlot::ShowValue() is deprecated. Use plot->value->Show() instead.");
    }
...
// PUBLIC METHODS	
	...
	for($i=0; $i<$this->numpoints-1; $i++) {
		...
		$this->plots[$j]->value->SetVAlign("center");
