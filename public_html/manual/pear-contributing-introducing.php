...
setupNavigation(array(
  ...
  'prev' => array('pear-contributing-requirements.php', 'Requirements'),
  ...
  'toc'  => array(
    ...
    array('contributing-howto.php#pear-contributing-introduction', 'Introduction'),
    array('pear-contributing-requirements.php', 'Requirements'),
    array('pear-contributing-introducing.php', 'Introducing your code'))));
manualHeader('Introducing your code','pear-contributing-introducing.php');
?><DIV
CLASS="sect1"
><H1
CLASS="sect1"
><A
NAME="pear-contributing-introducing"
...
></DIV
><?php manualFooter('Introducing your code','pear-contributing-introducing.php');
?>