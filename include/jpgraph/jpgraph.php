...
// for arcs. If you don't have GD2 installed this must be set to false!
...
// TTF Font families$this->scale->ticks->maj_ticks_label
...
// PRIVATE METHODS	
	...
	while( $i<$nbr ) {
		...
		if( $this->scale->type == "x" ) {
			//echo "<br>ticks_label <br>";print_r($this->ticks_label);
			//echo "<p> maj_ticks_label";print_r($this->scale->ticks->maj_ticks_label);
...
// PUBLIC METHODS	
	...
	JpGraphError::Raise(" Deprecated function Legend::SetBackground() use Legend::SetFillColor() instead.");
    }
