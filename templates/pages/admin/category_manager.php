<?php $this->extend('layout.php', ['title' => 'Administration - Category manager']) ?>
...
<script>
    ...
    <?php foreach($categories as $c): ?>
        categories[<?= $this->noHtml($c['id']) ?>] = new Array('<?= $this->noHtml($c['name']) ?>', '<?= $this->e($c['description']) ?>');
    <?php endforeach ?>
</script>
    ...
    <tr>
        ...
        <td valign="top">
            <?php if (!empty($message)): ?>
                <span class="error"><?= $this->e($message) ?></span>
            <?php endif ?>
            ...
            <table>
                ...
                <tr>
                    <td>Name</td>
                    <td><input type="text" name="catName" size="25" required></td>
                </tr>
                <tr>
                    <td>Description</td>
                    <td><input type="text" name="catDesc" size="25" required></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td><input type="submit" value="Add category" name="addUpdateSubmit"></td>
                </tr>
            </table>
